...
FILE構造体は、libio/bits/types/struct_FILE.hにて定義されている。

_IO_FILEのマクロの存在には留意しておきたい。#ifdef _IO_USE_OLD_IO_FILEはfopenの時には(おそらく)無視されるので、_IO_FILE_completeは読み込まれない。
...
_IO_save_end    = 0x0,
_markers        = 0x0,
_chain          = 0x7ffff7fa16a0,  //stderrにつながっている
_fileno         = 0x3,
_flags2         = 0x0,
_old_offset     = 0x0,
_cur_column     = 0x0,
